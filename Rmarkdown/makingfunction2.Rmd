...
# run apply on garden sample over over columns (1 is row, 2 is columns)
...
# all named items
# "[" for this list i want to extract the element called simpson 
...
# why use unlist fucntion
## results of apply are in a list which isnt super helpful 
## unlist helps with turning something into a dataframe
## just takes everything in the list and collapses it into a string
## turn the unlist into a matrix makes it into columns
## turns a list into something more management

many_gardens_sum = 
  # in each element of the list there were 2 things --> 2 columns
  as.data.frame(matrix(unlist(many_gardens_result_aslist), 
                                        ncol=2, byrow=T))
